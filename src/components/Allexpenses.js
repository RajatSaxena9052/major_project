        ...
        return selfPaid ?
            <div class="border-2 border-bottom" style={{ display: this.state.display }}>
                <div className="row flex-nowrap">
                    ...
                    <div class="col col-sm-4 col-lg-5 text-start align-self-center">{description}</div>
                    ...
                    <div class="col d-flex align-items-center text-danger"><a type="button" onClick={this.removeExpense} > X</a></div>
                </div>
            </div >
            :
            <div class="p-2 border-2 border-bottom" style={{ display: this.state.display }}>
                <div className="row flex-nowrap">
                    ...
                    <div class="col col-lg-1 text-secondary fs-6"> {friendName} paid <br /><span className="text-dark fw-bold"> Rs {amountPaid} </span></div>
                    <div class="col col-lg-1  text-secondary fs-6">{friendName} lent you <br /><font color="#ff652f" > <strong> Rs {equalSplit} </strong></font></div>
