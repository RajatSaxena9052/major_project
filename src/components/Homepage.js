            ...
            <div class="container-fluid">
                ...
                <div class="container mb-5">
                    ...
                    <ul class="row text-start row-cols-sm-2 row-cols-lg-3" >
                        ...
                        <div class="col">
                            <ul className="list-unstyled">
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> A totally ad-free experience</li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Currency conversion</li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Receipt scanning</li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Itemization </li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Charts and graphs </li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Expense search</li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Save default splits </li>
                                <li><img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon"  ></img> Early access to new features</li>
                            </ul>
                        </div>
                ...
                <div class="row justify-content-center flex-row text-xs mt-7 mb-5">
                    <span ><img src="https://assets.splitwise.com/assets/core/core-feature.svg" alt="icon" /> Pro features   <img src="https://assets.splitwise.com/assets/pro/pro-feature.svg" alt="icon" /> Core features</span>
                </div>
                ...
                <div className="container mb-5">
                    ...
                    <div class="row row-cols-md-2 row-cols-lg-3 row-cols-sm-1">
                        ...
                        <div class="col box border rounded home-card mb-3 ">
                            <a href="https://www.ft.com/content/8ccd6f0e-18bb-11e9-b93e-f4351a53f1c3" className="remove-link-decoration text-dark">
                        ...
                        <div class="col box border rounded text-start home-card mb-3">
                            <a href="https://www.nytimes.com/2018/08/28/smarter-living/money-finance-apps-tools.html" className="remove-link-decoration text-dark">
                                <div class="px-5 pt-4 pb-4 flex-column">
                        ...
                        <div class="col box border rounded text-start home-card mb-3">
                            <a href="https://www.businessinsider.com.au/best-apps-for-splitting-expenses-friends-2017-3#/#i-discovered-splitwise-when-i-moved-into-an-apartment-with-three-male-roommates-we-shared-the-cost-of-pretty-much-everything-from-furniture-to-take-out-from-wingstop-1" class="remove-link-decoration text-dark">
                                <div class="px-5 pt-4 pb-4 flex-column">
