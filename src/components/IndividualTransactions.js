    ...
    render() {
        ...
        return selfPaid ?
            ...
            <div class="col pt-3 pb-3 border-2 border-bottom flex-nowrap">
                <div className="row flex-nowrap">
                    <div class="col col-sm-1 align-self-center"><img src="https://s3.amazonaws.com/splitwise/uploads/category/icon/square_v2/uncategorized/general@2x.png" height="35px" width="35px" alt="generalIcon" /></div>
                    <div class="col-6 col-sm-1 text-start align-self-center">{description}</div>
